...
KamalaginABinaryImageConvexHull2ALL::KamalaginABinaryImageConvexHull2ALL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = HullList{};
}

bool KamalaginABinaryImageConvexHull2ALL::ValidationImpl() {
...
bool KamalaginABinaryImageConvexHull2ALL::PreProcessingImpl() {
  GetOutput().clear();
  return true;
}

bool KamalaginABinaryImageConvexHull2ALL::RunImpl() {
  GetOutput() = SolveAllMpi(GetInput());
  return true;
}

bool KamalaginABinaryImageConvexHull2ALL::PostProcessingImpl() {
  return true;
}
