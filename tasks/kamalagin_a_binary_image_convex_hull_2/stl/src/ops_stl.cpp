...
KamalaginABinaryImageConvexHull2STL::KamalaginABinaryImageConvexHull2STL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = HullList{};
}

bool KamalaginABinaryImageConvexHull2STL::ValidationImpl() {
...
bool KamalaginABinaryImageConvexHull2STL::PreProcessingImpl() {
  GetOutput().clear();
  return true;
}

bool KamalaginABinaryImageConvexHull2STL::RunImpl() {
  RunBinaryImageConvexHullStl(GetInput(), GetOutput());
  return true;
}

bool KamalaginABinaryImageConvexHull2STL::PostProcessingImpl() {
  return true;
}
